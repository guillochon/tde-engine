...
\author{James Guillochon\altaffilmark{1} and Abraham Loeb\altaffilmark{2}}
\altaffiltext{1}{Gentleman astrophysicist}
...
\begin{equation}
\Gamma_{\rm TDE} = 4 \times 10^{-5} \mhsix^{4/3}\left(\frac{n_{0}}{10^{5}~{\rm pc}^{-3}}\right)\left(\frac{100~{\rm km~s}^{-1}}{\sigma_{\rm h}}\right)^{3}~{\rm yr}^{-1},\label{eq:gtde}
\end{equation}
