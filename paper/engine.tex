...
\begin{align}
\dot{p}_{\rm CCSNe} &= 2 \times 10^{32} \left(\frac{\Gamma_{\rm CCSNe} (r < {\rm kpc})}{10^{-4}}\right)~{\rm g~cm~s}^{-2}\label{eq:psne}.
\end{align}
