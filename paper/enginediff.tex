...
%DIF ADD new.tex   Wed Aug 26 21:14:03 2026
...
\DIFdelbegin %DIFDELCMD < \email{jguillochon@cfa.harvard.edu}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{guillochon@gmail.com}
\DIFaddend 

\begin{abstract} 
\DIFdelbegin \DIFdel{It has been recently suggested that tidal }\DIFdelend \DIFaddbegin \DIFadd{Tidal }\DIFaddend disruption events (TDEs) \DIFaddbegin \DIFadd{appear to }\DIFaddend prefer host galaxies \DIFdelbegin \DIFdel{that are undergoing(or have undergone) }\DIFdelend \DIFaddbegin \DIFadd{undergoing, or recovering from, }\DIFaddend a burst of \DIFdelbegin \DIFdel{recent }\DIFdelend star formation, \DIFdelbegin \DIFdel{which suggests that a }\DIFdelend \DIFaddbegin \DIFadd{implying that a rare }\DIFaddend minority of galaxy types \DIFdelbegin \DIFdel{may be responsible for the majority of events. Because the disruptions occur in galaxies that are intrinsically rare, their individual ratesmay be }\DIFdelend \DIFaddbegin \DIFadd{produces most events. The required per-galaxy rates, }\DIFaddend as high as $10^{-2}$ \DIFdelbegin \DIFdel{~}\DIFdelend gal$^{-1}$ \DIFdelbegin \DIFdel{~}\DIFdelend yr$^{-1}$, \DIFdelbegin \DIFdel{which is difficult }\DIFdelend \DIFaddbegin \DIFadd{are hard }\DIFaddend to achieve through stellar relaxation alone. \DIFdelbegin \DIFdel{The molecular clouds that surround nuclear clusters play an important role in setting the stellar relaxation rateand thus the rate of tidal disruption, and can provide a path for increasing the rate above what stellar relaxation can provide}\DIFdelend \DIFaddbegin \DIFadd{Molecular clouds surrounding nuclear clusters help set the relaxation rate, offering a path to higher rates}\DIFaddend . We show that (post-)starburst galaxies, \DIFdelbegin \DIFdel{for which nearby prototypes are observed to }\DIFdelend \DIFaddbegin \DIFadd{whose nearby prototypes }\DIFaddend contain significant molecular gas reservoirs, are likely in a self-sustaining cycle\DIFdelbegin \DIFdel{where an enhancement in the rate of tidal disruption results in an increase in }\DIFdelend \DIFaddbegin \DIFadd{: an enhanced disruption rate increases }\DIFaddend the density of the surrounding \DIFdelbegin \DIFdel{molecular clouds due to }\DIFdelend \DIFaddbegin \DIFadd{clouds via }\DIFaddend momentum injection from the unbound debris of \DIFdelbegin \DIFdel{tidal disruptions. This suggests that current and future tidal disruption }\DIFdelend \DIFaddbegin \DIFadd{disruptions. Solving for the steady state, the rate saturates at $3\times10^{-3}$--$4\times10^{-2}(M_{\rm h}/10^{6}M_\odot)^{-1/6}$ yr$^{-1}$, tens to hundreds of times the canonical rate, the range reflecting whether the clouds form a spherical belt or a flattened disk. Either way the black hole is surrounded by parsec-scale clouds of density $10^{4}$--$10^{5}$ cm$^{-3}$ closely resembling those of the Milky Way's Central Molecular Zone, with a total mass of a few $\times10^{5}M_\odot$ comparable to the molecular disks now resolved around nearby active nuclei. Because stars fed from a disk return their debris to the plane they came from, the feedback is self-focusing. The state is self-limiting: stellar collisions cap the rate, and the engine consumes its fuel on a timescale of $10^{8}$--$10^{9}$ yr, comparable to the ages of post-starburst hosts. Because the equilibrium nucleus is heavily obscured ($A_{\rm V}\sim50$), we predict that the highest-rate nuclei are systematically missing from optically selected samples and should instead be found in the infrared, and that }\DIFaddend surveys should target galaxies \DIFdelbegin \DIFdel{that contain central gas }\DIFdelend \DIFaddbegin \DIFadd{with central }\DIFaddend reservoirs of the densest molecular gas \DIFdelbegin \DIFdel{that are }\DIFdelend accompanied by low levels of AGN activity.
\end{abstract}
...
\caption{Conditions by which TDEs dominate nuclear feedback for a variety of Bondi accretion efficiencies \DIFdelbeginFL \DIFdelFL{/Eddington ratios $f_{\rm Edd}^{2}/f_{\rm B}$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$f_{\rm B}$ }\DIFaddendFL and local SNe rates $\Gamma_{\rm SNe}$, with \DIFdelbeginFL \DIFdelFL{$f_{\rm Edd}^{2}/f_{\rm B}$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$f_{\rm B}$ }\DIFaddendFL varying from $10^{-4}$ to 1 from \DIFdelbeginFL \DIFdelFL{top }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{left }\DIFaddendFL to \DIFdelbeginFL \DIFdelFL{bottom }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{right }\DIFaddendFL and $\Gamma_{\rm SNe}$ varying from $10^{-5}$~yr$^{-1}$ to \DIFdelbeginFL \DIFdelFL{0.1}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$10^{-1}$}\DIFaddendFL ~yr$^{-1}$ from bottom to top (both in decade increments). \DIFaddbeginFL \DIFaddFL{Because the Eddington ratio is tied to the disruption rate through the equilibrium relation, the AGN boundaries steepen and become vertical once $f_{\rm Edd}$ saturates, which is why the orange family is ordered left to right rather than top to bottom. }\DIFaddendFL Within the orange (purple) regions, TDEs dominate AGN (SNe) feedback for the given values of \DIFdelbeginFL \DIFdelFL{$f_{\rm Edd}^{2}/f_{\rm B}$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$f_{\rm B}$ }\DIFaddendFL and $\Gamma_{\rm SNe}$. The vertical black dashed line indicates the limit where solar-mass stars are swallowed whole for non-spinning black holes before losing any mass via tides.}
\label{fig:rates}
\end{figure}
...
\begin{figure*}[t]
\DIFaddendFL \centering\includegraphics[width=0.4\linewidth,clip=true]{dominance.pdf}
...
\DIFdelend \bigskip
\acknowledgements
We thank Fabio~Antonini, Blakesley~Burkhart, Xian~Chen, Charlie~Conroy, Robert~Fisher, Nathan~Goldbaum, Luke~Zoltan-Kelley, Morgan~MacLeod, Peter~Maksym, Ilya~Mandel, Michael~McCourt, Smadar~Naoz, Ryan~O'Leary, Enrico~Ramirez-Ruiz, Lorenzo~Sironi, and Nicholas~Stone for thoughtful discussions. This work was supported in part by Einstein grant PF3-140108 (J.~G.). J.~G. would like to thank the Aspen Center for Physics (NSF Grant \#1066293) for their generous hospitality. \DIFaddbegin \DIFadd{First paper draft was originally completed circa 2018; paper was updated in 2026 with the assistance of the Anthropic AI models Claude Fable and Opus 5. All references and AI edits were hand-checked by the authors.}\footnote{\DIFadd{The manuscript source, the bibliography, and the scripts that solve the equilibrium system and generate the figures are available at }\url{https://github.com/guillochon/tde-engine}\DIFadd{.}}
\DIFaddend 
